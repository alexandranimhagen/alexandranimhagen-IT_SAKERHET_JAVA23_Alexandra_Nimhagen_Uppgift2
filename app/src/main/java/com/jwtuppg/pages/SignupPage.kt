...
fun SignupPage(modifier: Modifier = Modifier, navController: NavController, authViewModel: AuthViewModel) {
    ...
    Column(
        ...
        Button(onClick = {
            // Add a Toast to confirm button press
            Toast.makeText(context, "Create Account button clicked", Toast.LENGTH_SHORT).show()

            // Add logging to verify values
            Log.d("SignupPage", "Signup triggered with email: $email and password: $password")
